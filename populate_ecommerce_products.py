...
def populate_products():
    ...
    products_data = [
        ...
        },
        {
            ...
            'cost_price': 45.00,
            'available_online': True,
            'image_filename': 'BluetoothSpeaker.jpg',
        },
        {
            'name': 'Fitness Tracker',
            'description': 'Wearable device to track daily activity and health',
            'category': categories[3] if len(categories) > 3 else categories[0],
            'brand': brands[1] if len(brands) > 1 else brands[0],
            'unit_price': 149.99,
            'cost_price': 90.00,
            'available_online': True,
            'image_filename': 'FitnessTracker.jpg',
        },
    ]
